package com.examly.class_exercise_2.modelabu;

import jakarta.persistence.Entity;
import jakarta.persistence.Id;

@Entity
public class Courseabu {
     ...
     public Courseabu(int courseId, String courseName, int creditHours, String instructor, String preRequistes,
